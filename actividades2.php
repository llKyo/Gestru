                ...
                <div class="row">
                    <div class="col-md-3 ml-auto">
                        <div class="form-group">
                            <label for="selectObra">Filtrar actividades según fase</label>
                    ...
                    <div class="col-md-3 mr-auto ">
                        <div class="form-group">
                            ...
                            <button class="btn btn-warning form-control text-uppercase font-weight-bold" onclick="buscarFase()"
                                id="buscarObraBtn">Filtrar</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="js/actividades2.js"></script>
